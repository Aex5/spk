...
function FormRegister() {
    ...
    const [registerError, setRegisterError] = useState(null); // Error state variable

    async function submitHandler (e){
        e.preventDefault();

        if (data.email !== registerError?.email) {
        ...
        if (RegisterRes.status === "success") {
            setRegisterError({ message: "Email already in use" }); // Set specific error
